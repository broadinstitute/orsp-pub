...
class UrlMappings {
    ...
    static mappings = {
        ...
        "/api/report/get-pi-list"(controller: "report", action: "getPiList", method: "GET")
        "/api/report/delete-pi-report"(controller: "report", action: "excludeDataFromReport", method: "DELETE")
