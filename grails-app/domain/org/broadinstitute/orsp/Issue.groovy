...
//                case 'project':
//                    println 'checking Project type documents approved'
//                    println it.status != IssueStatus.Approved.getName() && !ProjectKeyDocument.getType(it.fileType).isEmpty()
//                    break
//            }
