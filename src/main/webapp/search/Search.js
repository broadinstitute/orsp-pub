...
class Search extends React.Component {
    constructor(props) {
        ...
        this.state = {
            ...
            defaultProjectSelected: this.getLocalStorageState('defaultProjectSelected', "array"),
            userName: this.getLocalStorageState('userName', "string"),
            defaultUserSelected: this.getLocalStorageState('defaultUserSelected', "array"),
    ...
    componentDidMount() {
        ...
        if (this.state.projectKey.length > 0 ||
    ...
    getLocalStorageState(key, type) {
        ...
        if (localStorageState == null || (typeof localStorageState[key] === 'undefined')) {
            if (type === "string") {
                return "";
            } else if (type === "array") {
                return [];
        ...
        return (
            <div>
                ...
                <form onSubmit={this.handleSubmit}>
                    ...
                    <div className={"row"}>
                        <div className={"form-group col-md-6"}>
                            <input type={"submit"} className={"btn btn-primary"} value={"Search"} ref={"search"} style={{marginRight: '1rem'}}/>
