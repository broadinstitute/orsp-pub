...
class DataUseRestrictionDetails extends Component {
  ...
  createRow(columnLeft, columnRight, link, style) {
        ...
        Panel({
          title: "Data Use Restriction Details"
            ...
            ul({ style: styles.tableList }, [
              ...
              this.createRow('Principal Investigator listed on the informed consent form', this.state.restriction.consentPIName, styles.tableListRow),
