  ...
  render() {
    ...
    return (
      WizardStep({
        ...
        error: this.props.errors.fundings || this.props.errors.studyDescription || this.props.errors.pTitle || this.props.errors.uploadConsentGroup || this.props.errors.subjectProtection || this.props.errors.attestation,
