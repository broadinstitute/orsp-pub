  ...
  render() {
    ...
    return (
      div({className: 'internationlCohortsBar'}, [
        QuestionnaireWorkflow({ questions: this.state.questions, handler: this.props.handler, determination: this.props.determination, questionnaireUnwrapped: true, internationalCohorts: true })
      ])
    )
  }
});
