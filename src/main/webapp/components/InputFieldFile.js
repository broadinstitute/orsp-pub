    ...
    return (
      div({ className: "inputFileContainer" }, [
        InputField({ label: this.props.label, aclaration: this.props.aclaration }, [
          div({ className: "col-lg-2 col-md-3 col-sm-3 col-xs-12 btn buttonSecondary buttonUpload" }, [
            "Select File",
            input({ type: 'file', onChange: this.props.callback, className: "inputFieldFile" })
          ])
        ]),
        div({ className: "fileNameContainer col-lg-10 col-md-9 col-sm-9 col-xs-12" }, [
