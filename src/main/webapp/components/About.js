        ...
        div({className: "row"}, [
          ...
          div({ className: "col-md-10" }, [
            ...
            p({ isRendered: this.props.showWarning,
              ...
              "For more information about how to use the ORSP portal, please visit: ",
              a({href: "https://intranet.broadinstitute.org/research-subject-protection/orsp-portal-and-decision-tree"},
                  ["https://intranet.broadinstitute.org/research-subject-protection/orsp-portal-and-decision-tree"])
            ]),
            p({ isRendered: this.props.showWarning,
