...
export const NewSecurityReview = hh(class NewSecurityReview extends Component {
  ...
  render() {
    ...
    return (
      div({},[
        div({isRendered: !this.props.compareChange}, [
        ...
        div({
          ...
          SecurityChangeComparison({
            ...
            secondaryUseAnswer: this.props.secondaryUseAnswer,
            storeOptions: this.props.storeOptions,
            getBoolIfString: this.props.getBoolIfString,
            compareChange: this.props.compareChange,
            prevSeqData: this.props.prevSeqData
          })
        ])
      ])
    )
